...
WiFiClient client;  
unsigned long myChannelNumber =  806348;  
const char * myWriteAPIKey = "0F1WSW5TG6999Y4L";  
 ...
 void temp()
{
  ...
  float temp_val = (temp/2048)*3300;
  float temp_c =  temp_val*0.1;

   Serial.print("temp");
  
  Serial.println(temp_c);
    ThingSpeak.writeField(myChannelNumber,2,temp_c, myWriteAPIKey);  
               delay(30000);
}
